<script>
    // props allow customization of card title amd description
    export let title = "Card Title";
    export let description = "This is a brief desciption of the card";
</script>

<div class="card">
    
    <img src="placeholer.png" alt="Placeholder"
